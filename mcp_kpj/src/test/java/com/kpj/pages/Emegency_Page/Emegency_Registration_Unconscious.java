 ...
 */
public class Emegency_Registration_Unconscious extends BasePage {

    public Emegency_Registration_Unconscious(Page page) { super(page); }
    ...
    public String fillMandatoryIfEmpty() {
        ...
        Object r = page.evaluate("async () => { const norm=s=>(s||'').replace(/\\s+/g,' ').trim();"
                ...
                + " await new Promise(r=>setTimeout(r,600)); out.Department=setSel('Visit.DepartmentID','');"
