...
/**
 * Application Configuration &gt; Inventory &gt; <b>Generic</b> — Page Object.
 *
...
public class Generic extends BasePage {
    ...
    public Generic(Page page) { super(page); }
    ...
    /**
     * Application Configuration &rarr; Inventory &rarr; Generic.
     *
    ...
    public boolean navigateViaMenu(String baseUrl) {
        ...
        Object href = page.evaluate("() => {" + JS
                ...
                + "   .find(x=>/^\\s*generic\\s*$/i.test(norm(x.textContent)));"
                + " if(!a) return ''; a.id='__gnMenu'; return a.getAttribute('href')||''; }");
        ...
        if (!lastRoute.isEmpty()) {
            ...
            catch (Exception e) { System.out.println("Generic.nav: " + e.getMessage().split("\n")[0]); }
    ...
    public boolean waitForScreenControls(int timeoutMs) {
        try {
            ...
            System.out.println("Generic.waitForScreenControls: no Code box or grid within "
    ...
    /**
     * On the Generic screen — matched on the hash route, never on page text.
     *
    ...
    public boolean onScreen() {
        ...
        if (route.contains("genmst") || route.contains("generic")) return true;
    ...
    public String describeControls() {
        ...
        System.out.println("=== Generic CONTROLS ===\n" + lastControls);
        return lastControls;
    }
    ...
    public String openFormIfNeeded() {
        ...
        page.evaluate("() => {" + JS
                ...
                + "        || /add-?generic|AddGeneric|GENMST/i.test((x.getAttribute('href')||'')"
                + "             +' '+(x.getAttribute('ng-click')||'')));"
                + " if(b) b.id='__gnAdd'; }");
        try {
            page.locator("#__gnAdd").click(new com.microsoft.playwright.Locator.ClickOptions().setTimeout(6000));
        } catch (Exception e) {
            System.out.println("Generic.openFormIfNeeded: " + e.getMessage().split("\n")[0]);
        }
    ...
    public String enterDetails(String code, String remark) {
        ...
        waitForAngular(500);
        System.out.println("Generic: " + lastEntry);
        return lastEntry;
    }
    ...
    public String submitAndGetToast() {
        ...
        lastToast = toast;
        System.out.println("Generic: submit -> " + lastSaveDiagnostics + " toast=\"" + toast + "\"");
        return toast;
    }
    ...
    public boolean codeInList(String code, String remark) {
        ...
        System.out.println("Generic: list check -> " + lastListCheck);
