 ...
 */
public class UnitParameter extends BasePage {

    public UnitParameter(Page page) { super(page); }
    ...
    /**
     * Application Configuration &rarr; Inventory &rarr; UnitParameter.
     *
    ...
    public boolean navigateViaMenu(String baseUrl) {
        ...
        Object href = page.evaluate("() => {" + JS
                ...
                + "   .find(x=>/^\\s*unit\\s*parameter\\s*$/i.test(norm(x.textContent)));"
                + " if(!a) return ''; a.id='__upMenu'; return a.getAttribute('href')||''; }");
        lastRoute = href == null ? "" : href.toString();
        if (!lastRoute.isEmpty()) {
            try { page.locator("#__upMenu").click(new com.microsoft.playwright.Locator.ClickOptions().setTimeout(6000)); }
            catch (Exception e) { System.out.println("UnitParameter.nav: " + e.getMessage().split("\n")[0]); }
            page.evaluate("() => { const e=document.getElementById('__upMenu'); if(e) e.removeAttribute('id'); }");
            waitForAngular(3000);
        }
    ...
    public boolean waitForScreenControls(int timeoutMs) {
        try {
            ...
            System.out.println("UnitParameter.waitForScreenControls: no Code box or grid within "
    ...
    /**
     * On the UnitParameter screen — matched on the hash route, never on page text.
     *
    ...
    public boolean onScreen() {
        ...
        if (route.contains("unitparameter") || route.contains("unitparam")
    ...
    public String describeControls() {
        ...
        System.out.println("=== UnitParameter CONTROLS ===\n" + lastControls);
        return lastControls;
    }
    ...
    public String openFormIfNeeded() {
        ...
        page.evaluate("() => {" + JS
                ...
                + "        || /add-?unit|AddUnitParameter|GENMST/i.test((x.getAttribute('href')||'')"
                + "             +' '+(x.getAttribute('ng-click')||'')));"
                + " if(b) b.id='__upAdd'; }");
        try {
            page.locator("#__upAdd").click(new com.microsoft.playwright.Locator.ClickOptions().setTimeout(6000));
        } catch (Exception e) {
            System.out.println("UnitParameter.openFormIfNeeded: " + e.getMessage().split("\n")[0]);
        }
        page.evaluate("() => { const e=document.getElementById('__upAdd'); if(e) e.removeAttribute('id'); }");
        waitForAngular(1500);
    ...
    public String enterDetails(String code, String remark) {
        ...
        waitForAngular(500);
        System.out.println("UnitParameter: " + lastEntry);
        return lastEntry;
    }
    ...
    public String enterMims(String guid, String description) {
        ...
        waitForAngular(500);
        System.out.println("UnitParameter: " + lastMims);
        return lastMims;
    }
    ...
    public String selectMimsType() {
        ...
        Object info = page.evaluate("() => {" + JS
                + " document.querySelectorAll('#__upMims').forEach(e=>e.removeAttribute('id'));"
                + " const e=[...document.querySelectorAll('select')].filter(vis)"
                + "   .find(s=>/mimstype/i.test(tail(s)));"
                + " if(!e) return null; e.id='__upMims';"
        ...
        try {
            page.locator("#__upMims").selectOption(
        ...
        waitForAngular(900);
        Object t = page.evaluate("() => { const e=document.getElementById('__upMims');"
                + " return e? ((e.options[e.selectedIndex]||{}).text||'').trim() : ''; }");
        lastMimsType = (t == null ? "" : t.toString()) + " [" + m.get("ng") + ", " + m.get("count") + " options]";
        System.out.println("UnitParameter: MIMS Type = " + lastMimsType);
        return lastMimsType;
    }
    ...
    public String enterMimsDescription(String description) {
        ...
        lastMims = r == null ? "" : r.toString();
        waitForAngular(500);
        System.out.println("UnitParameter: MIMS Description = " + lastMims);
        return lastMims;
    }
    ...
    public String submitAndGetToast() {
        ...
        lastToast = toast;
        System.out.println("UnitParameter: submit -> " + lastSaveDiagnostics + " toast=\"" + toast + "\"");
        return toast;
    }
    ...
    public boolean codeInList(String code, String remark) {
        ...
        System.out.println("UnitParameter: list check -> " + lastListCheck);
