...
// The page object is also named TypeOfReturn — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Inventory &gt; <b>Type of Return</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>Inventory</b> → <b>Type of Return</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL type of return in the target environment.</p>
 */
public class TypeOfReturn extends DevHisBase {
    ...
    protected void body() {
        ...
        String code = System.getProperty("code", "TR" + stamp);
        String remark = System.getProperty("remark", "Auto type of return " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.Inventory_page.TypeOfReturn tor =
                new com.kpj.pages.ApplicationConfiguration_page.Inventory_page.TypeOfReturn(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("Inventory submenu offered", tor.lastMenu);
        step(page, "Open Type of Return screen",
                "Click Application Configuration -> Inventory -> Type of Return",
                "The Type of Return screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.Inventory_page.TypeOfReturn.isSuccess(toast);
        ...
        step(page, "Verify the type of return was created", "Look for " + code + " in the list",
                "The new type of return is listed",
                (inList
