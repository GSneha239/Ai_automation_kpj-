...
public class StockAdjustmentReasonMaster extends DevHisBase {
    ...
    public StockAdjustmentReasonMaster() { super("ApplicationConfiguration_StockAdjustmentReasonMaster"); }
    ...
    @Override
    protected void body() {
        meta("Stock Adjustment Reason Master", "Application Configuration > Inventory > Stock Adjustment Reason Master",
