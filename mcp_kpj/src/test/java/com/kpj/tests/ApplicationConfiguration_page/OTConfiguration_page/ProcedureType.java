...
// The page object is also named ProcedureType — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; OT Configuration &gt; <b>Procedure Type</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>OT Configuration</b> → <b>Procedure Type</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL procedure type in the target environment.</p>
 */
public class ProcedureType extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public ProcedureType() { super("ApplicationConfiguration_OTConfiguration_ProcedureType"); }
    ...
    @Override
    protected void body() {
        meta("Application Configuration - OT Configuration - Procedure Type", "Application Configuration > OT Configuration > Procedure Type",
                "&#9888; Creates a REAL procedure type: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "PTY" + stamp);
        String remark = System.getProperty("remark", "Auto procedure type " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.OTConfiguration_page.ProcedureType tor =
                new com.kpj.pages.ApplicationConfiguration_page.OTConfiguration_page.ProcedureType(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("OT Configuration submenu offered", tor.lastMenu);
        step(page, "Open Procedure Type screen",
                "Click Application Configuration -> OT Configuration -> Procedure Type",
                "The Procedure Type screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.OTConfiguration_page.ProcedureType.isSuccess(toast);
        ...
        step(page, "Verify the procedure type was created", "Look for " + code + " in the list",
                "The new procedure type is listed",
                (inList
