...
// The page object is also named HistoTemplate — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Investigation &gt; <b>HistoTemplate</b>.
 *
 * <ol>
 *   <li>Open <b>Application Configuration</b> → <b>Investigation</b> → <b>HistoTemplate</b> (clicking <b>Add</b> first
 ...
 * </ol>
 */
public class HistoTemplate extends DevHisBase {

    /** How many times to re-enter fresh details when the server says the code / remark already exists. */
    private static final int MAX_ATTEMPTS = 40;

    public HistoTemplate() { super("ApplicationConfig_Investigation_HistoTemplate"); }

    public static void main(String[] args) {
        HistoTemplate t = new HistoTemplate();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Investigation - Histo Template",
                "Application Configuration > Investigation > Histo Template",
                "Add a Histo Template: Add, enter Code + Name + Remark, Submit; wait for the success toast. "
        ...
        com.kpj.pages.ApplicationConfiguration_page.Investigation_page.HistoTemplate ag =
                new com.kpj.pages.ApplicationConfiguration_page.Investigation_page.HistoTemplate(page);
        ...
        step(page, "Open Histo Template screen", "Application Configuration -> Investigation -> Histo Template",
                "The Histo Template screen is shown",
                on ? "Opened " + landed
                   : "WRONG PAGE - expected Histo Template but the app opened: " + landed + "\n" + ag.describeForm(),
                on ? "PASS" : "FAIL");
        ...
        for (int attempt = 0; attempt < MAX_ATTEMPTS; attempt++) {
            ...
            System.out.println("HistoTemplate: attempt " + used + " (" + details + ") already exists — changing the details");
        }

        boolean detOk = details.contains("Code=HT") && !details.contains("(no field)") && !details.contains("(no description field)");
        ...
        addSummary("Histo Template Code", ag.lastCode);
