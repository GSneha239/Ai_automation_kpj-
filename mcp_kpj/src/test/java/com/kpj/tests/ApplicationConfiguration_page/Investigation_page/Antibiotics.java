...
// The page object is also named Antibiotics — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Investigation &gt; <b>Antibiotics</b>.
 *
 * <ol>
 *   <li>Open <b>Application Configuration</b> → <b>Investigation</b> → <b>Antibiotics</b> (clicking <b>Add</b> first
 ...
 * </ol>
 */
public class Antibiotics extends DevHisBase {

    /** How many times to re-enter fresh details when the server says the code / remark already exists. */
    private static final int MAX_ATTEMPTS = 40;

    public Antibiotics() { super("ApplicationConfig_Investigation_Antibiotics"); }

    public static void main(String[] args) {
        Antibiotics t = new Antibiotics();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Investigation - Antibiotics",
                "Application Configuration > Investigation > Antibiotics",
                "Add an Antibiotics: enter Code + Remark, Submit; wait for the success toast. "
        ...
        com.kpj.pages.ApplicationConfiguration_page.Investigation_page.Antibiotics ag =
                new com.kpj.pages.ApplicationConfiguration_page.Investigation_page.Antibiotics(page);
        ...
        step(page, "Open Antibiotics screen", "Application Configuration -> Investigation -> Antibiotics",
                "The Antibiotics screen is shown",
                on ? "Opened " + landed
                   : "WRONG PAGE - expected Antibiotics but the app opened: " + landed + "\n" + ag.describeForm(),
                on ? "PASS" : "FAIL");
        ...
        for (int attempt = 0; attempt < MAX_ATTEMPTS; attempt++) {
            ...
            System.out.println("Antibiotics: attempt " + used + " (" + details + ") already exists — changing the details");
        }

        boolean detOk = details.contains("Code=AB") && !details.contains("(no field)");
        ...
        addSummary("Antibiotics Code", ag.lastCode);
