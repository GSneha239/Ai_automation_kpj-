...
// The page object is also named ComplaintStatus — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Equipment &gt; <b>Complaint Status</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>Equipment</b> → <b>Complaint Status</b>.</li>
 ...
 */
public class ComplaintStatus extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public ComplaintStatus() { super("ApplicationConfiguration_Equipment_ComplaintStatus"); }

    public static void main(String[] args) {
        ComplaintStatus t = new ComplaintStatus();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Equipment - Complaint Status", "Application Configuration > Equipment > Complaint Status",
        ...
        String code = System.getProperty("code", "CST" + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.Equipment_page.ComplaintStatus tor =
                new com.kpj.pages.ApplicationConfiguration_page.Equipment_page.ComplaintStatus(page);
        ...
        step(page, "Open Complaint Status screen",
                "Click Application Configuration -> Equipment -> Complaint Status",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.Equipment_page.ComplaintStatus.isSuccess(toast);
