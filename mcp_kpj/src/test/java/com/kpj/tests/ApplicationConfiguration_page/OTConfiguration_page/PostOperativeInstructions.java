...
public class PostOperativeInstructions extends DevHisBase {
    ...
    public PostOperativeInstructions() { super("ApplicationConfiguration_PostOperativeInstructions"); }
    ...
    @Override
    protected void body() {
        meta("Post Operative Instructions", "Application Configuration > OT Configuration > Post Operative Instructions",
