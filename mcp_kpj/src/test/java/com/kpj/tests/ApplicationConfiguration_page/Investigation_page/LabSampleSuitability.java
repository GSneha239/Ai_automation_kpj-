...
// The page object is also named LabSampleSuitability — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Investigation &gt; <b>LabSampleSuitability</b>.
 *
 * <ol>
 *   <li>Open <b>Application Configuration</b> → <b>Investigation</b> → <b>LabSampleSuitability</b> (clicking <b>Add</b> first
 ...
 * </ol>
 */
public class LabSampleSuitability extends DevHisBase {

    /** How many times to re-enter fresh details when the server says the code / remark already exists. */
    private static final int MAX_ATTEMPTS = 40;

    public LabSampleSuitability() { super("ApplicationConfig_Investigation_LabSampleSuitability"); }

    public static void main(String[] args) {
        LabSampleSuitability t = new LabSampleSuitability();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Investigation - LabSampleSuitability",
                "Application Configuration > Investigation > LabSampleSuitability",
                "Add an LabSampleSuitability: enter Code + Remark, Submit; wait for the success toast. "
        ...
        com.kpj.pages.ApplicationConfiguration_page.Investigation_page.LabSampleSuitability ag =
                new com.kpj.pages.ApplicationConfiguration_page.Investigation_page.LabSampleSuitability(page);
        ...
        step(page, "Open LabSampleSuitability screen", "Application Configuration -> Investigation -> LabSampleSuitability",
                "The LabSampleSuitability screen is shown",
                on ? "Opened " + landed
                   : "WRONG PAGE - expected LabSampleSuitability but the app opened: " + landed + "\n" + ag.describeForm(),
                on ? "PASS" : "FAIL");
        ...
        for (int attempt = 0; attempt < MAX_ATTEMPTS; attempt++) {
            ...
            System.out.println("LabSampleSuitability: attempt " + used + " (" + details + ") already exists — changing the details");
        }

        boolean detOk = details.contains("Code=LS") && !details.contains("(no field)");
        ...
        addSummary("Lab Sample Suitability Code", ag.lastCode);
        addSummary("Remark", ag.lastRemark);
        addSummary("Remark 2", ag.lastRemark2);
