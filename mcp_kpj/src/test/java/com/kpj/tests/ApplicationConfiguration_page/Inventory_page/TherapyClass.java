...
// The page object is also named TherapyClass — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Inventory &gt; <b>Therapy Class</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>Inventory</b> → <b>Therapy Class</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL therapy class in the target environment.</p>
 */
public class TherapyClass extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public TherapyClass() { super("ApplicationConfiguration_Inventory_TherapyClass"); }

    public static void main(String[] args) {
        TherapyClass t = new TherapyClass();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Inventory - Therapy Class", "Application Configuration > Inventory > Therapy Class",
                "&#9888; Creates a REAL therapy class: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "THC" + stamp);
        String remark = System.getProperty("remark", "Auto therapy class " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.Inventory_page.TherapyClass tor =
                new com.kpj.pages.ApplicationConfiguration_page.Inventory_page.TherapyClass(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("Inventory submenu offered", tor.lastMenu);
        step(page, "Open Therapy Class screen",
                "Click Application Configuration -> Inventory -> Therapy Class",
                "The Therapy Class screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.Inventory_page.TherapyClass.isSuccess(toast);
        ...
        step(page, "Verify the therapy class was created", "Look for " + code + " in the list",
                "The new therapy class is listed",
                (inList
