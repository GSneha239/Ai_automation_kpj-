...
// The page object is also named ApplicableOn — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Inventory &gt; <b>Applicable On</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>Inventory</b> → <b>Applicable On</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL applicable on in the target environment.</p>
 */
public class ApplicableOn extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public ApplicableOn() { super("ApplicationConfiguration_Inventory_ApplicableOn"); }

    public static void main(String[] args) {
        ApplicableOn t = new ApplicableOn();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Inventory - Applicable On", "Application Configuration > Inventory > Applicable On",
                "&#9888; Creates a REAL applicable on: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "APO" + stamp);
        String remark = System.getProperty("remark", "Auto applicable on " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.Inventory_page.ApplicableOn tor =
                new com.kpj.pages.ApplicationConfiguration_page.Inventory_page.ApplicableOn(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("Inventory submenu offered", tor.lastMenu);
        step(page, "Open Applicable On screen",
                "Click Application Configuration -> Inventory -> Applicable On",
                "The Applicable On screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.Inventory_page.ApplicableOn.isSuccess(toast);
        ...
        step(page, "Verify the applicable on was created", "Look for " + code + " in the list",
                "The new applicable on is listed",
                (inList
