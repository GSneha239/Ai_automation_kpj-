...
// The page object is also named PregnancyClass — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Inventory &gt; <b>Pregnancy Class</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>Inventory</b> → <b>Pregnancy Class</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL pregnancy class in the target environment.</p>
 */
public class PregnancyClass extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public PregnancyClass() { super("ApplicationConfiguration_Inventory_PregnancyClass"); }

    public static void main(String[] args) {
        PregnancyClass t = new PregnancyClass();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Inventory - Pregnancy Class", "Application Configuration > Inventory > Pregnancy Class",
                "&#9888; Creates a REAL pregnancy class: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "PGC" + stamp);
        String remark = System.getProperty("remark", "Auto pregnancy class " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.Inventory_page.PregnancyClass tor =
                new com.kpj.pages.ApplicationConfiguration_page.Inventory_page.PregnancyClass(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("Inventory submenu offered", tor.lastMenu);
        step(page, "Open Pregnancy Class screen",
                "Click Application Configuration -> Inventory -> Pregnancy Class",
                "The Pregnancy Class screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.Inventory_page.PregnancyClass.isSuccess(toast);
        ...
        step(page, "Verify the pregnancy class was created", "Look for " + code + " in the list",
                "The new pregnancy class is listed",
                (inList
