...
// The page object is also named ItemClass — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Inventory &gt; <b>Item Class</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>Inventory</b> → <b>Item Class</b>.</li>
 ...
 */
public class ItemClass extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public ItemClass() { super("ApplicationConfiguration_Inventory_ItemClass"); }

    public static void main(String[] args) {
        ItemClass t = new ItemClass();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Inventory - Item Class", "Application Configuration > Inventory > Item Class",
        ...
        String code = System.getProperty("code", "ICL" + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.Inventory_page.ItemClass tor =
                new com.kpj.pages.ApplicationConfiguration_page.Inventory_page.ItemClass(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("Inventory submenu offered", tor.lastMenu);
        step(page, "Open Item Class screen",
                "Click Application Configuration -> Inventory -> Item Class",
                "The Item Class screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.Inventory_page.ItemClass.isSuccess(toast);
