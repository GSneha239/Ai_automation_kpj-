...
// The page object is also named AmcAgent — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Equipment &gt; <b>AMC Agent</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>Equipment</b> → <b>AMC Agent</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL AMC agent in the target environment.</p>
 */
public class AmcAgent extends DevHisBase {
    ...
    protected void body() {
        ...
        String code = System.getProperty("code", "AMC" + stamp);
        String remark = System.getProperty("remark", "Auto AMC agent " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.Equipment_page.AmcAgent tor =
                new com.kpj.pages.ApplicationConfiguration_page.Equipment_page.AmcAgent(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("Equipment submenu offered", tor.lastMenu);
        step(page, "Open AMC Agent screen",
                "Click Application Configuration -> Equipment -> AMC Agent",
                "The AMC Agent screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.Equipment_page.AmcAgent.isSuccess(toast);
        ...
        step(page, "Verify the AMC agent was created", "Look for " + code + " in the list",
                "The new AMC agent is listed",
                (inList
