...
// The page object is also named ComplaintCategory — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Equipment &gt; <b>Complaint Category</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>Equipment</b> → <b>Complaint Category</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL complaint category in the target environment.</p>
 */
public class ComplaintCategory extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public ComplaintCategory() { super("ApplicationConfiguration_Equipment_ComplaintCategory"); }

    public static void main(String[] args) {
        ComplaintCategory t = new ComplaintCategory();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Equipment - Complaint Category", "Application Configuration > Equipment > Complaint Category",
                "&#9888; Creates a REAL complaint category: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "CCT" + stamp);
        String remark = System.getProperty("remark", "Auto complaint category " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.Equipment_page.ComplaintCategory tor =
                new com.kpj.pages.ApplicationConfiguration_page.Equipment_page.ComplaintCategory(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("Equipment submenu offered", tor.lastMenu);
        step(page, "Open Complaint Category screen",
                "Click Application Configuration -> Equipment -> Complaint Category",
                "The Complaint Category screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.Equipment_page.ComplaintCategory.isSuccess(toast);
        ...
        step(page, "Verify the complaint category was created", "Look for " + code + " in the list",
                "The new complaint category is listed",
                (inList
