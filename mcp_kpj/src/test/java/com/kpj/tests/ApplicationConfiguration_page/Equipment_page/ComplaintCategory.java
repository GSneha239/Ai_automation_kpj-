...
public class ComplaintCategory extends DevHisBase {
    ...
    public ComplaintCategory() { super("ApplicationConfiguration_ComplaintCategory"); }
    ...
    @Override
    protected void body() {
        meta("Complaint Category", "Application Configuration > Equipment > Complaint Category",
