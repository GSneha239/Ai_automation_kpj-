...
public class ChecklistCategoryMaster extends DevHisBase {
    ...
    public ChecklistCategoryMaster() { super("ApplicationConfiguration_ChecklistCategoryMaster"); }
    ...
    @Override
    protected void body() {
        meta("Checklist Category Master", "Application Configuration > OT Configuration > Checklist Category Master",
