...
// The page object is also named AnesthesiaType — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; OT Configuration &gt; <b>Anesthesia Type</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>OT Configuration</b> → <b>Anesthesia Type</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL anesthesia type in the target environment.</p>
 */
public class AnesthesiaType extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public AnesthesiaType() { super("ApplicationConfiguration_OTConfiguration_AnesthesiaType"); }

    public static void main(String[] args) {
        AnesthesiaType t = new AnesthesiaType();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - OT Configuration - Anesthesia Type", "Application Configuration > OT Configuration > Anesthesia Type",
                "&#9888; Creates a REAL anesthesia type: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "ANT" + stamp);
        String remark = System.getProperty("remark", "Auto anesthesia type " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.OTConfiguration_page.AnesthesiaType tor =
                new com.kpj.pages.ApplicationConfiguration_page.OTConfiguration_page.AnesthesiaType(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("OT Configuration submenu offered", tor.lastMenu);
        step(page, "Open Anesthesia Type screen",
                "Click Application Configuration -> OT Configuration -> Anesthesia Type",
                "The Anesthesia Type screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.OTConfiguration_page.AnesthesiaType.isSuccess(toast);
        ...
        step(page, "Verify the anesthesia type was created", "Look for " + code + " in the list",
                "The new anesthesia type is listed",
                (inList
