...
public class IntraOperativeInstructions extends DevHisBase {
    ...
    public IntraOperativeInstructions() { super("ApplicationConfiguration_IntraOperativeInstructions"); }
    ...
    @Override
    protected void body() {
        meta("Intra Operative Instructions", "Application Configuration > OT Configuration > Intra Operative Instructions",
