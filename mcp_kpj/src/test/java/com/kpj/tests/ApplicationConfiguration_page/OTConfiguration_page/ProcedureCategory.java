...
// The page object is also named ProcedureCategory — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; OT Configuration &gt; <b>Procedure Category</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>OT Configuration</b> → <b>Procedure Category</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL procedure category in the target environment.</p>
 */
public class ProcedureCategory extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public ProcedureCategory() { super("ApplicationConfiguration_OTConfiguration_ProcedureCategory"); }

    public static void main(String[] args) {
        ProcedureCategory t = new ProcedureCategory();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - OT Configuration - Procedure Category", "Application Configuration > OT Configuration > Procedure Category",
                "&#9888; Creates a REAL procedure category: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "PCG" + stamp);
        String remark = System.getProperty("remark", "Auto procedure category " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.OTConfiguration_page.ProcedureCategory tor =
                new com.kpj.pages.ApplicationConfiguration_page.OTConfiguration_page.ProcedureCategory(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("OT Configuration submenu offered", tor.lastMenu);
        step(page, "Open Procedure Category screen",
                "Click Application Configuration -> OT Configuration -> Procedure Category",
                "The Procedure Category screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.OTConfiguration_page.ProcedureCategory.isSuccess(toast);
        ...
        step(page, "Verify the procedure category was created", "Look for " + code + " in the list",
                "The new procedure category is listed",
                (inList
