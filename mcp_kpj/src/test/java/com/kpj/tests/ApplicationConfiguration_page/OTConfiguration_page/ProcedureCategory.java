...
public class ProcedureCategory extends DevHisBase {
    ...
    public ProcedureCategory() { super("ApplicationConfiguration_ProcedureCategory"); }
    ...
    @Override
    protected void body() {
        meta("Procedure Category", "Application Configuration > OT Configuration > Procedure Category",
