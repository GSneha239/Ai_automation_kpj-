...
// The page object is also named DocumentCategory — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; General &gt; <b>Document Category</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>General</b> → <b>Document Category</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL document category in the target environment.</p>
 */
public class DocumentCategory extends DevHisBase {
    ...
    protected void body() {
        ...
        String code = System.getProperty("code", "DCG" + stamp);
        String remark = System.getProperty("remark", "Auto document category " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.General_page.DocumentCategory tor =
                new com.kpj.pages.ApplicationConfiguration_page.General_page.DocumentCategory(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("General submenu offered", tor.lastMenu);
        step(page, "Open Document Category screen",
                "Click Application Configuration -> General -> Document Category",
                "The Document Category screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.General_page.DocumentCategory.isSuccess(toast);
        ...
        step(page, "Verify the document category was created", "Look for " + code + " in the list",
                "The new document category is listed",
                (inList
