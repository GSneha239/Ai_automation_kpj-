...
// The page object is also named Film — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Investigation &gt; <b>Film</b>.
 *
 * <ol>
 *   <li>Open <b>Application Configuration</b> → <b>Investigation</b> → <b>Film</b> (clicking <b>Add</b> first
...
public class Film extends DevHisBase {
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Investigation - Film",
                "Application Configuration > Investigation > Film",
                "Add an Film: enter Code + Remark, Submit; wait for the success toast. "
        ...
        com.kpj.pages.ApplicationConfiguration_page.Investigation_page.Film ag =
                new com.kpj.pages.ApplicationConfiguration_page.Investigation_page.Film(page);
        ...
        step(page, "Open Film screen", "Application Configuration -> Investigation -> Film",
                "The Film screen is shown",
                on ? "Opened " + landed
                   : "WRONG PAGE - expected Film but the app opened: " + landed + "\n" + ag.describeForm(),
                on ? "PASS" : "FAIL");
        ...
        for (int attempt = 0; attempt < MAX_ATTEMPTS; attempt++) {
            ...
            System.out.println("Film: attempt " + used + " (" + details + ") already exists — changing the details");
        }

        boolean detOk = details.contains("Code=FM") && !details.contains("(no field)");
        ...
        addSummary("Film Code", ag.lastCode);
