...
// The page object is also named ModeOfScrapSale — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Inventory &gt; <b>Mode of Scrap Sale</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>Inventory</b> → <b>Mode of Scrap Sale</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL mode of scrap sale in the target environment.</p>
 */
public class ModeOfScrapSale extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public ModeOfScrapSale() { super("ApplicationConfiguration_Inventory_ModeOfScrapSale"); }

    public static void main(String[] args) {
        ModeOfScrapSale t = new ModeOfScrapSale();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Inventory - Mode of Scrap Sale", "Application Configuration > Inventory > Mode of Scrap Sale",
                "&#9888; Creates a REAL mode of scrap sale: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "MSS" + stamp);
        String remark = System.getProperty("remark", "Auto mode of scrap sale " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.Inventory_page.ModeOfScrapSale tor =
                new com.kpj.pages.ApplicationConfiguration_page.Inventory_page.ModeOfScrapSale(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("Inventory submenu offered", tor.lastMenu);
        step(page, "Open Mode of Scrap Sale screen",
                "Click Application Configuration -> Inventory -> Mode of Scrap Sale",
                "The Mode of Scrap Sale screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.Inventory_page.ModeOfScrapSale.isSuccess(toast);
        ...
        step(page, "Verify the mode of scrap sale was created", "Look for " + code + " in the list",
                "The new mode of scrap sale is listed",
                (inList
