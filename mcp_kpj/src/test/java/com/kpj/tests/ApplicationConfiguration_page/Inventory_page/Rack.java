...
// The page object is also named Rack — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Inventory &gt; <b>Rack</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>Inventory</b> → <b>Rack</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL rack in the target environment.</p>
 */
public class Rack extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public Rack() { super("ApplicationConfiguration_Inventory_Rack"); }
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Inventory - Rack", "Application Configuration > Inventory > Rack",
                "&#9888; Creates a REAL rack: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "RCK" + stamp);
        String remark = System.getProperty("remark", "Auto rack " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.Inventory_page.Rack tor =
                new com.kpj.pages.ApplicationConfiguration_page.Inventory_page.Rack(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("Inventory submenu offered", tor.lastMenu);
        step(page, "Open Rack screen",
                "Click Application Configuration -> Inventory -> Rack",
                "The Rack screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.Inventory_page.Rack.isSuccess(toast);
        ...
        step(page, "Verify the rack was created", "Look for " + code + " in the list",
                "The new rack is listed",
                (inList
