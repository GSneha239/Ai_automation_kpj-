...
// The page object is also named PreventiveChecklist — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Equipment &gt; <b>Preventive Checklist</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>Equipment</b> → <b>Preventive Checklist</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL preventive checklist in the target environment.</p>
 */
public class PreventiveChecklist extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public PreventiveChecklist() { super("ApplicationConfiguration_Equipment_PreventiveChecklist"); }

    public static void main(String[] args) {
        PreventiveChecklist t = new PreventiveChecklist();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Equipment - Preventive Checklist", "Application Configuration > Equipment > Preventive Checklist",
                "&#9888; Creates a REAL preventive checklist: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "PVC" + stamp);
        String remark = System.getProperty("remark", "Auto preventive checklist " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.Equipment_page.PreventiveChecklist tor =
                new com.kpj.pages.ApplicationConfiguration_page.Equipment_page.PreventiveChecklist(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("Equipment submenu offered", tor.lastMenu);
        step(page, "Open Preventive Checklist screen",
                "Click Application Configuration -> Equipment -> Preventive Checklist",
                "The Preventive Checklist screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.Equipment_page.PreventiveChecklist.isSuccess(toast);
        ...
        step(page, "Verify the preventive checklist was created", "Look for " + code + " in the list",
                "The new preventive checklist is listed",
                (inList
