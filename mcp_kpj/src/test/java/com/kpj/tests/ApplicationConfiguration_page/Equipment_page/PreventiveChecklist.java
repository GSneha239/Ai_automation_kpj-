...
public class PreventiveChecklist extends DevHisBase {
    ...
    public PreventiveChecklist() { super("ApplicationConfiguration_PreventiveChecklist"); }
    ...
    @Override
    protected void body() {
        meta("Preventive Checklist", "Application Configuration > Equipment > Preventive Checklist",
