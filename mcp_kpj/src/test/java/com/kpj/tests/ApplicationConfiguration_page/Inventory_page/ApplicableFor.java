...
// The page object is also named ApplicableFor — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Inventory &gt; <b>Applicable For</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>Inventory</b> → <b>Applicable For</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL applicable for in the target environment.</p>
 */
public class ApplicableFor extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public ApplicableFor() { super("ApplicationConfiguration_Inventory_ApplicableFor"); }

    public static void main(String[] args) {
        ApplicableFor t = new ApplicableFor();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Inventory - Applicable For", "Application Configuration > Inventory > Applicable For",
                "&#9888; Creates a REAL applicable for: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "APF" + stamp);
        String remark = System.getProperty("remark", "Auto applicable for " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.Inventory_page.ApplicableFor tor =
                new com.kpj.pages.ApplicationConfiguration_page.Inventory_page.ApplicableFor(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("Inventory submenu offered", tor.lastMenu);
        step(page, "Open Applicable For screen",
                "Click Application Configuration -> Inventory -> Applicable For",
                "The Applicable For screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.Inventory_page.ApplicableFor.isSuccess(toast);
        ...
        step(page, "Verify the applicable for was created", "Look for " + code + " in the list",
                "The new applicable for is listed",
                (inList
