...
public class PreOperativeInstructions extends DevHisBase {
    ...
    public PreOperativeInstructions() { super("ApplicationConfiguration_PreOperativeInstructions"); }
    ...
    @Override
    protected void body() {
        meta("Pre Operative Instructions", "Application Configuration > OT Configuration > Pre Operative Instructions",
