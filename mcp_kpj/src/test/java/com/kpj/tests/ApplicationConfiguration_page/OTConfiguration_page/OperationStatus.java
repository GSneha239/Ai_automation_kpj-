...
public class OperationStatus extends DevHisBase {
    ...
    public OperationStatus() { super("ApplicationConfiguration_OperationStatus"); }
    ...
    @Override
    protected void body() {
        meta("Operation Status", "Application Configuration > OT Configuration > Operation Status",
