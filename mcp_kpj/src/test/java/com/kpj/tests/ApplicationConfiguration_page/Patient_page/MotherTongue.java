...
// The page object is also named MotherTongue — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Patient &gt; <b>Mother Tongue</b>.
 *
 * <ol>
 *   <li>Open <b>Application Configuration</b> → <b>Patient</b> → <b>Mother Tongue</b> (clicking <b>Add</b>
 ...
 * </ol>
 */
public class MotherTongue extends DevHisBase {

    /** How many times to re-enter fresh details when the server says the code / remark already exists. */
    private static final int MAX_ATTEMPTS = 40;

    public MotherTongue() { super("ApplicationConfig_Patient_MotherTongue"); }

    public static void main(String[] args) {
        MotherTongue t = new MotherTongue();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Patient - Mother Tongue",
                "Application Configuration > Patient > Mother Tongue",
                "Add a Mother Tongue: enter Code + Remark, Submit; wait for the success toast. On "
        ...
        com.kpj.pages.ApplicationConfiguration_page.Patient_page.MotherTongue mt =
                new com.kpj.pages.ApplicationConfiguration_page.Patient_page.MotherTongue(page);
        ...
        step(page, "Open Mother Tongue screen", "Application Configuration -> Patient -> Mother Tongue",
                "The Mother Tongue screen is shown",
                on ? "Opened " + landed
                   : "WRONG PAGE - expected Mother Tongue but the app opened: " + landed + "\n" + mt.describeForm(),
                on ? "PASS" : "FAIL");
        ...
        for (int attempt = 0; attempt < MAX_ATTEMPTS; attempt++) {
            ...
            catch (Exception e) { System.out.println("MotherTongue: filled-form screenshot failed - " + e.getMessage()); }
            toast = mt.submitAndGetToast();
            String tl = toast == null ? "" : toast.toLowerCase();
            ok = tl.contains("saved") || tl.contains("success") || tl.contains("added") || tl.contains("updated");
            exists = tl.contains("exist") || tl.contains("already");
            if (ok || !exists) break;   // saved, or a different (non-retryable) message
            System.out.println("MotherTongue: attempt " + used + " (" + details + ") already exists — changing the details");
        }
        ...
        addSummary("Mother Tongue Code", mt.lastCode);
