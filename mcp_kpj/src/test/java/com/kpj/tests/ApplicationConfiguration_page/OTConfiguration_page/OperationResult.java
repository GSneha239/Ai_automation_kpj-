...
public class OperationResult extends DevHisBase {
    ...
    public OperationResult() { super("ApplicationConfiguration_OperationResult"); }
    ...
    @Override
    protected void body() {
        meta("Operation Result", "Application Configuration > OT Configuration > Operation Result",
