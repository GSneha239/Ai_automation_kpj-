...
// The page object is also named OperationResult — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; OT Configuration &gt; <b>Operation Result</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>OT Configuration</b> → <b>Operation Result</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL operation result in the target environment.</p>
 */
public class OperationResult extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public OperationResult() { super("ApplicationConfiguration_OTConfiguration_OperationResult"); }

    public static void main(String[] args) {
        OperationResult t = new OperationResult();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - OT Configuration - Operation Result", "Application Configuration > OT Configuration > Operation Result",
                "&#9888; Creates a REAL operation result: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "OPR" + stamp);
        String remark = System.getProperty("remark", "Auto operation result " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.OTConfiguration_page.OperationResult tor =
                new com.kpj.pages.ApplicationConfiguration_page.OTConfiguration_page.OperationResult(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("OT Configuration submenu offered", tor.lastMenu);
        step(page, "Open Operation Result screen",
                "Click Application Configuration -> OT Configuration -> Operation Result",
                "The Operation Result screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.OTConfiguration_page.OperationResult.isSuccess(toast);
        ...
        step(page, "Verify the operation result was created", "Look for " + code + " in the list",
                "The new operation result is listed",
                (inList
