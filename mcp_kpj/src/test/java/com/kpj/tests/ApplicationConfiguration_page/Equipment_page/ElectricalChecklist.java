...
public class ElectricalChecklist extends DevHisBase {
    ...
    public ElectricalChecklist() { super("ApplicationConfiguration_ElectricalChecklist"); }
    ...
    @Override
    protected void body() {
        meta("Electrical Checklist", "Application Configuration > Equipment > Electrical Checklist",
