...
// The page object is also named ElectricalChecklist — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Equipment &gt; <b>Electrical Checklist</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>Equipment</b> → <b>Electrical Checklist</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL electrical checklist in the target environment.</p>
 */
public class ElectricalChecklist extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public ElectricalChecklist() { super("ApplicationConfiguration_Equipment_ElectricalChecklist"); }

    public static void main(String[] args) {
        ElectricalChecklist t = new ElectricalChecklist();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Equipment - Electrical Checklist", "Application Configuration > Equipment > Electrical Checklist",
                "&#9888; Creates a REAL electrical checklist: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "ELC" + stamp);
        String remark = System.getProperty("remark", "Auto electrical checklist " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.Equipment_page.ElectricalChecklist tor =
                new com.kpj.pages.ApplicationConfiguration_page.Equipment_page.ElectricalChecklist(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("Equipment submenu offered", tor.lastMenu);
        step(page, "Open Electrical Checklist screen",
                "Click Application Configuration -> Equipment -> Electrical Checklist",
                "The Electrical Checklist screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.Equipment_page.ElectricalChecklist.isSuccess(toast);
        ...
        step(page, "Verify the electrical checklist was created", "Look for " + code + " in the list",
                "The new electrical checklist is listed",
                (inList
