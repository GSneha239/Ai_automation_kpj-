...
// The page object is also named ComplianceType — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Equipment &gt; <b>Compliance Type</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>Equipment</b> → <b>Compliance Type</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL compliance type in the target environment.</p>
 */
public class ComplianceType extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public ComplianceType() { super("ApplicationConfiguration_Equipment_ComplianceType"); }

    public static void main(String[] args) {
        ComplianceType t = new ComplianceType();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Equipment - Compliance Type", "Application Configuration > Equipment > Compliance Type",
                "&#9888; Creates a REAL compliance type: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "CMT" + stamp);
        String remark = System.getProperty("remark", "Auto compliance type " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.Equipment_page.ComplianceType tor =
                new com.kpj.pages.ApplicationConfiguration_page.Equipment_page.ComplianceType(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("Equipment submenu offered", tor.lastMenu);
        step(page, "Open Compliance Type screen",
                "Click Application Configuration -> Equipment -> Compliance Type",
                "The Compliance Type screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.Equipment_page.ComplianceType.isSuccess(toast);
        ...
        step(page, "Verify the compliance type was created", "Look for " + code + " in the list",
                "The new compliance type is listed",
                (inList
