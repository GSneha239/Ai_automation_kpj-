...
// The page object is also named Country — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; General &gt; <b>Country</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>General</b> → <b>Country</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL country in the target environment.</p>
 */
public class Country extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public Country() { super("ApplicationConfiguration_General_Country"); }
    ...
    @Override
    protected void body() {
        meta("Application Configuration - General - Country", "Application Configuration > General > Country",
                "&#9888; Creates a REAL country: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "CNY" + stamp);
        String remark = System.getProperty("remark", "Auto country " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.General_page.Country tor =
                new com.kpj.pages.ApplicationConfiguration_page.General_page.Country(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("General submenu offered", tor.lastMenu);
        step(page, "Open Country screen",
                "Click Application Configuration -> General -> Country",
                "The Country screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.General_page.Country.isSuccess(toast);
        ...
        step(page, "Verify the country was created", "Look for " + code + " in the list",
                "The new country is listed",
                (inList
