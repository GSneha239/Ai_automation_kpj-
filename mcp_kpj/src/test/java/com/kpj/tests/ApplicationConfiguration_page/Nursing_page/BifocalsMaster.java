...
// The page object is also named BifocalsMaster — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Nursing &gt; <b>Bifocals</b> ({@code #/Bifocals}) — INLINE-ADD screen.
 *
 * <ol>
 *   <li>Open <b>Application Configuration</b> → <b>Nursing</b> → <b>Bifocals</b> (no Add button — the form
 *       is on the screen).</li>
 *   <li>Enter <b>Code*</b> and <b>Remark*</b>.</li>
 *   <li>Click <b>Submit</b> ({@code fnIUDCommonMaster}); wait for the success toast.</li>
 * </ol>
 */
public class BifocalsMaster extends DevHisBase {

    public BifocalsMaster() { super("ApplicationConfig_Nursing_Bifocals"); }

    public static void main(String[] args) {
        BifocalsMaster t = new BifocalsMaster();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Nursing - Bifocals",
                "Application Configuration > Nursing > Bifocals",
                "Add an Bifocals (inline-add): enter Code + Remark, Submit; wait for the success toast.");

        LoginPage loginPage = new LoginPage(page);
        loginPage.login(BASE, USER, PASS);
        step("Login", USER + " login", "Authenticated; Patient Dashboard", "Logged in", "PASS");

        com.kpj.pages.ApplicationConfiguration_page.Nursing_page.BifocalsMaster am =
                new com.kpj.pages.ApplicationConfiguration_page.Nursing_page.BifocalsMaster(page);
        ...
        step(page, "Open Bifocals screen", "Application Configuration -> Nursing -> Bifocals",
                "The Bifocals screen (inline-add form) is shown",
                on ? "Opened " + landed : "WRONG PAGE - expected Bifocals but the app opened: " + landed,
                on ? "PASS" : "FAIL");
        if (!on) { addSummary("Result", "FAILED - wrong page opened: " + landed); return; }

        String details = am.fillDetails();
        boolean detOk = details.contains("Code=BF") && !details.contains("Remark=(no)");
        ...
        addSummary("Bifocals Code", am.lastCode);
        addSummary("Remark", am.lastRemark);
        addSummary("Route", "#/Bifocals (inline-add)");
