...
// The page object is also named CodeType — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Billing &gt; <b>Code Type</b>.
 *
 * <ol>
 *   <li>Open <b>Application Configuration</b> → <b>Billing</b> → <b>Code Type</b> (clicking <b>Add</b> first
...
public class CodeType extends DevHisBase {
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Billing - Code Type",
                "Application Configuration > Billing > Code Type",
                "Add a Code Type: enter Code + Remark, Submit; wait for the success toast. "
        ...
        com.kpj.pages.ApplicationConfiguration_page.Billing_page.CodeType ct =
                new com.kpj.pages.ApplicationConfiguration_page.Billing_page.CodeType(page);
        ...
        step(page, "Open Code Type screen", "Application Configuration -> Billing -> Code Type",
                "The Code Type screen is shown",
                on ? "Opened " + landed
                   : "WRONG PAGE - expected Code Type but the app opened: " + landed + "\n" + ct.describeForm(),
                on ? "PASS" : "FAIL");
        ...
        for (int attempt = 0; attempt < MAX_ATTEMPTS; attempt++) {
            ...
            catch (Exception e) { System.out.println("CodeType: filled-form screenshot failed - " + e.getMessage()); }
            toast = ct.submitAndGetToast();
            String tl = toast == null ? "" : toast.toLowerCase();
            ok = tl.contains("saved") || tl.contains("success") || tl.contains("added") || tl.contains("updated");
            exists = tl.contains("exist") || tl.contains("already");
            if (ok || !exists) break;   // saved, or a different (non-retryable) message
            System.out.println("CodeType: attempt " + used + " (" + details + ") already exists — changing the details");
        }
        ...
        addSummary("Code Type Code", ct.lastCode);
