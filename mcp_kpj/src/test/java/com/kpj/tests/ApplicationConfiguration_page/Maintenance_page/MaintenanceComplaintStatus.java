...
public class MaintenanceComplaintStatus extends DevHisBase {
    ...
    public MaintenanceComplaintStatus() { super("ApplicationConfiguration_MaintenanceComplaintStatus"); }
    ...
    @Override
    protected void body() {
        meta("Complaint Status", "Application Configuration > Maintenance > Complaint Status",
