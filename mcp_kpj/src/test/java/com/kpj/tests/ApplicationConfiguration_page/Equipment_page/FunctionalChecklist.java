...
// The page object is also named FunctionalChecklist — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; Equipment &gt; <b>Functional Checklist</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>Equipment</b> → <b>Functional Checklist</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL functional checklist in the target environment.</p>
 */
public class FunctionalChecklist extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public FunctionalChecklist() { super("ApplicationConfiguration_Equipment_FunctionalChecklist"); }

    public static void main(String[] args) {
        FunctionalChecklist t = new FunctionalChecklist();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - Equipment - Functional Checklist", "Application Configuration > Equipment > Functional Checklist",
                "&#9888; Creates a REAL functional checklist: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "FNC" + stamp);
        String remark = System.getProperty("remark", "Auto functional checklist " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.Equipment_page.FunctionalChecklist tor =
                new com.kpj.pages.ApplicationConfiguration_page.Equipment_page.FunctionalChecklist(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("Equipment submenu offered", tor.lastMenu);
        step(page, "Open Functional Checklist screen",
                "Click Application Configuration -> Equipment -> Functional Checklist",
                "The Functional Checklist screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.Equipment_page.FunctionalChecklist.isSuccess(toast);
        ...
        step(page, "Verify the functional checklist was created", "Look for " + code + " in the list",
                "The new functional checklist is listed",
                (inList
