...
public class FunctionalChecklist extends DevHisBase {
    ...
    public FunctionalChecklist() { super("ApplicationConfiguration_FunctionalChecklist"); }
    ...
    @Override
    protected void body() {
        meta("Functional Checklist", "Application Configuration > Equipment > Functional Checklist",
