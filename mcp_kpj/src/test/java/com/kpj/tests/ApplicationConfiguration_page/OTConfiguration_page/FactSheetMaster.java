...
public class FactSheetMaster extends DevHisBase {
    ...
    public FactSheetMaster() { super("ApplicationConfiguration_FactSheetMaster"); }
    ...
    @Override
    protected void body() {
        meta("Fact Sheet Master", "Application Configuration > OT Configuration > Fact Sheet Master",
