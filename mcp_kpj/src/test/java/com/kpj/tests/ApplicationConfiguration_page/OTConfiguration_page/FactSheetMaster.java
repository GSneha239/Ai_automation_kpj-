...
// The page object is also named FactSheetMaster — referenced by its fully-qualified name.

/**
 * Application Configuration &gt; OT Configuration &gt; <b>Fact Sheet Master</b>.
 *
 * <ol>
 *   <li>Login (shared {@link LoginPage}, on an OPD counter so the menu exists).</li>
 *   <li>Open <b>Application Configuration</b> → <b>OT Configuration</b> → <b>Fact Sheet Master</b>.</li>
 ...
 *
 * <p>&#9888; A successful run CREATES a REAL fact sheet in the target environment.</p>
 */
public class FactSheetMaster extends DevHisBase {

    /** DevHIS only builds the nav menu for an outpatient counter. Override with {@code -Dcounter=}. */
    public static final String COUNTER_FOR_MENU = "OPD-B-01";

    public FactSheetMaster() { super("ApplicationConfiguration_OTConfiguration_FactSheetMaster"); }

    public static void main(String[] args) {
        FactSheetMaster t = new FactSheetMaster();
    ...
    @Override
    protected void body() {
        meta("Application Configuration - OT Configuration - Fact Sheet Master", "Application Configuration > OT Configuration > Fact Sheet Master",
                "&#9888; Creates a REAL fact sheet: enter Code and Remark, then Submit.");

        String counter = System.getProperty("counter", COUNTER_FOR_MENU);
        String stamp = String.format("%05d", Math.abs(System.nanoTime() % 100000));
        String code = System.getProperty("code", "FSM" + stamp);
        String remark = System.getProperty("remark", "Auto fact sheet " + stamp);
        ...
        com.kpj.pages.ApplicationConfiguration_page.OTConfiguration_page.FactSheetMaster tor =
                new com.kpj.pages.ApplicationConfiguration_page.OTConfiguration_page.FactSheetMaster(page);

        // 1) Navigate
        boolean rendered = tor.navigateViaMenu(BASE);
        if (!rendered) addSummary("OT Configuration submenu offered", tor.lastMenu);
        step(page, "Open Fact Sheet Master screen",
                "Click Application Configuration -> OT Configuration -> Fact Sheet Master",
                "The Fact Sheet Master screen is shown",
        ...
        boolean ok = com.kpj.pages.ApplicationConfiguration_page.OTConfiguration_page.FactSheetMaster.isSuccess(toast);
        ...
        step(page, "Verify the fact sheet was created", "Look for " + code + " in the list",
                "The new fact sheet is listed",
                (inList
