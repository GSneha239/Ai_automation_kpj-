@echo off
REM ============================================================================
REM  Run the 6 core screens against devhis TWICE - once per patient type:
REM
REM     pass 1  MALAYSIAN patient  (New IC + NRIC)   -> test-output-core-devhis\
REM     pass 2  FOREIGN patient    (Passport + Visa) -> test-output-core-devhis-<Nationality>\
REM
...
REM      run-core-flows-devhis.bat American
REM
REM  Reports    : test-output-core-devhis*\reports\<Page>.html
REM  FAILED list: test-output-core-devhis*\FAILED_STEPS.html
...
echo ############################################################
call "%~dp0core-flows-runner.bat" devhis
set "RC1=%ERRORLEVEL%"
...
echo ############################################################
call "%~dp0core-flows-runner.bat" devhis %FOREIGN%
set "RC2=%ERRORLEVEL%"

set "CORE_NOPAUSE="
echo.
echo ============================================================
echo   Environment      : devhis - default URL/credentials built into the jar
echo   Pass 1 Malaysian : test-output-core-devhis\reports\
echo   Pass 2 %FOREIGN% : test-output-core-devhis-%FOREIGN%\reports\
