@echo off
REM ============================================================================
REM  DevHIS Playwright flows - Emergency module runner (no Maven needed)
...
set "MODULE=Emergency"
set "PKG=com.kpj.tests.Emergency_page"
if not defined OUTDIR set "OUTDIR=test-output-emergency"
