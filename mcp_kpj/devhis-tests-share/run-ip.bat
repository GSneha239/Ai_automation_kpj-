@echo off
REM ============================================================================
REM  DevHIS Playwright flows - IP module runner (no Maven needed)
REM  Runs every flow under com.kpj.tests.Ip (Bed Management, Occupancy, Discharge, Admission, ...)
...
set "MODULE=IP"
set "PKG=com.kpj.tests.Ip"
if not defined OUTDIR set "OUTDIR=test-output-ip"
