@echo off
REM ============================================================================
REM  DevHIS Playwright flows - Application Configuration module runner (no Maven needed)
...
set "MODULE=Application Configuration"
set "PKG=com.kpj.tests.ApplicationConfiguration_page"
if not defined OUTDIR set "OUTDIR=test-output-appconfig"
