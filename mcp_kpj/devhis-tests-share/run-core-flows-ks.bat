@echo off
REM ============================================================================
REM  Run the 6 core screens against ks TWICE - once per patient type:
REM
REM     pass 1  MALAYSIAN patient  (New IC + NRIC)   -> test-output-core-ks\
REM     pass 2  FOREIGN patient    (Passport + Visa) -> test-output-core-ks-<Nationality>\
REM
...
REM      run-core-flows-ks.bat American
REM
REM  Reports    : test-output-core-ks*\reports\<Page>.html
REM  FAILED list: test-output-core-ks*\FAILED_STEPS.html
...
echo ############################################################
call "%~dp0core-flows-runner.bat" ks
set "RC1=%ERRORLEVEL%"
...
echo ############################################################
call "%~dp0core-flows-runner.bat" ks %FOREIGN%
set "RC2=%ERRORLEVEL%"

set "CORE_NOPAUSE="
echo.
echo ============================================================
echo   Environment      : KS QA - https://ks-nhisqa.kpjhealth.com.my
echo   Pass 1 Malaysian : test-output-core-ks\reports\
echo   Pass 2 %FOREIGN% : test-output-core-ks-%FOREIGN%\reports\
