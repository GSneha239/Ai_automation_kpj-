@echo off
REM ============================================================================
REM  Run the 6 core screens against klg TWICE - once per patient type:
REM
REM     pass 1  MALAYSIAN patient  (New IC + NRIC)   -> test-output-core-klg\
REM     pass 2  FOREIGN patient    (Passport + Visa) -> test-output-core-klg-<Nationality>\
REM
...
REM      run-core-flows-klg.bat American
REM
REM  Reports    : test-output-core-klg*\reports\<Page>.html
REM  FAILED list: test-output-core-klg*\FAILED_STEPS.html
...
echo ############################################################
call "%~dp0core-flows-runner.bat" klg
set "RC1=%ERRORLEVEL%"
...
echo ############################################################
call "%~dp0core-flows-runner.bat" klg %FOREIGN%
set "RC2=%ERRORLEVEL%"

set "CORE_NOPAUSE="
echo.
echo ============================================================
echo   Environment      : KLG QA - https://klg-nhisqa.kpjhealth.com.my
echo   Pass 1 Malaysian : test-output-core-klg\reports\
echo   Pass 2 %FOREIGN% : test-output-core-klg-%FOREIGN%\reports\
